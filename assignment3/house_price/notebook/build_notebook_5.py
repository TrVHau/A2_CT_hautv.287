#!/usr/bin/env python3
"""Build house price Notebook 5 - Slide Reference vs Improved Custom Models."""
import json, os
...
cells.append(md("## 4. Tải mô hình Random Forest đã huấn luyện"))
cells.append(code(
...
cells.append(md("## 5. Bảng So Sánh Đối Chứng Chi Tiết (Slide Reference vs Improved)"))
cells.append(code(
"comp_hp_data = [\n"
"    {\n"
...
cells.append(md("## 6. Trực quan hoá mức độ cải thiện"))
cells.append(code(
